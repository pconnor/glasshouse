# RailsAdmin config file. Generated on December 07, 2011 20:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Glasshouseproject', 'Admin']
  ...
  # config.excluded_models = [BlogPost, Page]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [BlogPost, Page]
